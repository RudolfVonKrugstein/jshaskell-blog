...
var _0=0,_1=new T(function(){return unCStr("canvas1");}),_2=[0,300],_3=[0,_2],_4=[0,_3],_5=new T(function(){return unCStr("state");}),_6=new T(function(){return toJSStr(_5);}),_7=new T(function(){return toJSStr(_5);}),_8=function(_9,_){var _a=jsLoadGlobalObject(E(_7)[1]),_b=[0,_a][1];jsSaveGlobalObject(E(_6)[1],[0,new T(function(){switch(E(E(_9)[1])){case 37:return [0,new T(function(){return [0,E(E(_b)[1])[1]-3];})];case 39:return [0,new T(function(){return [0,E(E(_b)[1])[1]+3];})];default:return E(_b);}})][1]);return _0;},_c=function(_d,_e){var _f=E(_d);if(!_f[0]){return E(_e);}else{return [1,_f[1],new T(function(){return _c(_f[2],_e);})];}},_g=new T(function(){return unCStr(" could be found!");}),_h=function(_i){return err(unAppCStr("No element with ID ",new T(function(){return _c(_i,_g);})));},_j=function(_k,_){var _l=jsFind(toJSStr(_k)[1]),_m=E([0,_l][1]);if(!_m[0]){return _h(_k);}else{var _n=jsGetContext2D(E(_m[1])[1]);return [0,_n];}},_o=new T(function(){return unCStr("green");}),_p=new T(function(){return toJSStr(_o);}),_q="state",_r=[0,_q],_s=function(_){var _t=jsLoadGlobalObject(E(_r)[1]),_u=_j(_1,_),_v=E(_u)[1];jsClear(_v);jsSetFillColor(_v,E(_p)[1]);jsFillRect(_v,E(E([0,_t][1])[1])[1],380,60,20);return _0;},_w=[0,_s],_x="keydown",_y=[0,_x],_z=function(_A,_B,_){var _C=jsFind(toJSStr(_A)[1]),_D=E([0,_C][1]);if(!_D[0]){return _h(_A);}else{E(_B);var _E=jsSetCB(E(_D[1])[1],E(_y)[1],[0,_B][1]);return new T(function(){return E(_E)==0?false:true;});}},_F=function(_){jsSaveGlobalObject(E(_r)[1],E(_4)[1]);jsSetInterval(30,E(_w)[1]);_z(_1,_8,_);return _0;},_G=[0,_F],_H=function(_){jsSetOnLoad(E(_G)[1]);return _0;},_I=function(_){return _H(_);};
var hasteMain = function() {A(_I, [0]);};hasteMain();