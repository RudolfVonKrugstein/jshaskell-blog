...
foreign import js "%1.fillText(%*)" jsFillText :: Context2D -> JSString -> Double -> Double -> IO ()
fillText :: Context2D -> String -> Double -> Double -> IO ()
fillText ctx str = jsFillText ctx (toJS str)
